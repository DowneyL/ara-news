...
func init() {
	...
	ns := beego.NewNamespace("/v1",
		...
		beego.NSNamespace("/news",
			...
			beego.NSRouter("/category", &news.CategoryController{}, "get:List;post:Create;delete:BatchDelete"),
			beego.NSRouter("/category/:id([0-9]+)", &news.CategoryController{}, "get:Detail;delete:Delete"),
		),
	)
